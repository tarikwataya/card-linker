  ...
  <Link href={href}>
    <div className="transition duration-500 ease-in-out h-14 mt-6 flex flex-row bg-gray-400 bg-opacity-20 rounded-xl cursor-pointer hover:bg-gray-500 hover:bg-opacity-20 transform hover:-translate-y-1 hover:scale-110">      
      ...
      <div className="mt-3 sm:mt-2">
        ...
        <p className="hidden sm:block text-gray-300 text-sm">test description</p>
      </div>
    </div>
  </Link>
);
...
export default function Home() {
  return (
    <div className="flex justify-center">
      ...
      <div className="rounded-3xl overflow-hidden shadow w-4/5 sm:w-4/5 md:w-2/5 my-3 bg-gray-500 bg-opacity-20">
        <img src="https://i.imgur.com/GUIuOIN.jpg" className="w-full h-36 border-b-4 border-white" />
        ...
        <div className="pl-10 pr-10 pb-10 flex flex-col">
          <Card href="/tailwind" imgSrc="/img/instagram.svg" tittle="My instagram" />
          <Card href="/nextjs" imgSrc="/img/github.svg" tittle="My Github"/>
          <Card href="/nextjs" imgSrc="/img/portfolio.svg" tittle="My Portfolio"/>
          <Card href="/nextjs" imgSrc="/img/github.svg" tittle="My Github"/>
          <Card href="/nextjs" imgSrc="/img/portfolio.svg" tittle="My Portfolio"/>
        </div>
